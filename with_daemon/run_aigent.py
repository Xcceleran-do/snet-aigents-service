...
log = logging.getLogger("snet_aigents_service")
...
def start_service(cwd, service_module, run_daemon, daemon_config, run_ssl):
    ...
    def add_ssl_configs(conf):
        ...
        with open(conf, "r") as f:
            ...
            snetd_configs["ssl_cert"] = "/singnet/aigents/with_daemon/.certs/fullchain.pem"
            snetd_configs["ssl_key"] = "/singnet/aigents/with_daemon/.certs/privkey.pem"
